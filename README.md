...
## Overview
This repository contains Python solutions for the **February 2026 Data Science Internship Logic Building Task**.  
All problems are implemented using clean, well-structured code with proper comments.

The solutions demonstrate fundamental Python programming concepts such as:
